    ...
    return (
      <>
        ...
        <p className="hero-message">
          I'm an ambitious web developer from Oakville, ON.{" "}
          <span className="text-color-change">
            Specializing in React and PHP applications
          </span>
          , I enjoy building websites and web-applications that are both
          user-friendly and powerful.
        </p>
        <a href="#contact-section" className="btn btn--get-started">
          Let's get started
        </a>
      </>
    );
